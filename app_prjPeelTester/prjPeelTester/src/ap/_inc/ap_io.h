...
#define AP_IO_DEF_BASE_ADDR                       128
...
#define AP_IO_DEF_IO_ADDR_MCU_OUT_CYL_ON          AP_IO_DEF_BASE_ADDR+0
#define AP_IO_DEF_IO_ADDR_MCU_OUT_1               AP_IO_DEF_BASE_ADDR+1
#define AP_IO_DEF_IO_ADDR_MCU_OUT_2               AP_IO_DEF_BASE_ADDR+2
#define AP_IO_DEF_IO_ADDR_MCU_OUT_3               AP_IO_DEF_BASE_ADDR+3
#define AP_IO_DEF_IO_ADDR_MCU_OUT_4               AP_IO_DEF_BASE_ADDR+4
#define AP_IO_DEF_IO_ADDR_MCU_OUT_5               AP_IO_DEF_BASE_ADDR+5
#define AP_IO_DEF_IO_ADDR_MCU_OUT_6               AP_IO_DEF_BASE_ADDR+6
#define AP_IO_DEF_IO_ADDR_MCU_OUT_7               AP_IO_DEF_BASE_ADDR+7
...
#define ApIoAddr(x)                         AP_IO_DEF_BASE_ADDR+x
...
public:
  enum class in_e
  {
    mcu_in_cyl_1_on = AP_IO_DEF_BASE_ADDR,
    mcu_in_cyl_1_off,
    mcu_in_cyl_2_on,
    mcu_in_cyl_2_off,
    mcu_in_drum_vac_on,
  ...
  enum class out_e
  {
    mcu_out_cyl_1_on = AP_IO_DEF_BASE_ADDR,
    mcu_out_cyl_1_off,
    mcu_out_cyl_2_on,
    mcu_out_cyl_2_off,
    mcu_out_vac_1_on,
...
public:
  ...
  inline int SetGpioOut(out_e out_idx, bool onoff){
    ...
    switch (out_idx)
    {
      ...
      {
        if (onoff)
          pIo->OutputOn(static_cast<uint32_t>(out_idx) - AP_IO_DEF_BASE_ADDR + AP_IO_DEF_IO_ADDR_FM_DIFF_VALUE);
        else
          pIo->OutputOff(static_cast<uint32_t>(out_idx) - AP_IO_DEF_BASE_ADDR + AP_IO_DEF_IO_ADDR_FM_DIFF_VALUE);
      }
      break;
      case out_e::fm_out11:
        break;
  ...
  inline bool IsOn(uint32_t addr) {
    if (!(addr < static_cast<uint32_t>(ap_io::in_e::_max))) //not
      return false;
    div_t div_result = div((addr-AP_IO_DEF_BASE_ADDR),8);
  ...
  inline int OutputToggle(uint32_t addr){
    if (!(addr < static_cast<uint32_t>(ap_io::out_e::_max))) //not
      return -1;
    div_t div_result = div((addr-AP_IO_DEF_BASE_ADDR),8);//div_result.quot ; // 몫 //div_result.rem; // 나머지
