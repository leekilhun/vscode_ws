...
struct ap_dat
{
  ...
  dat_t apcfg_dat[static_cast<uint8_t>(ap_dat::addr_e::_max)];
...
struct axis_dat
{
  struct dat_t
  {
    ...
    uint32_t  cmd_vel{};
    /*
    inline int getCmdPos () const {
      return cmd_pos;
    }

    inline void setCmdPos(int pos) {
      cmd_pos = pos;
    }

    inline uint32_t getCmdVel () const {
      return cmd_vel;
    }

    inline void setCmdVel(uint32_t cmd_vel)  {
      cmd_vel = cmd_vel;
    }*/
  };
  ...
  dat_t cmd_pos_dat[static_cast<uint8_t>(axis_dat::addr_e::_max)];
...
struct cyl_dat{
  ...
  dat_t cyl_act_dat[static_cast<uint8_t>(cyl_dat::addr_e::_max)];
...
struct vac_dat{
  ...
  dat_t vac_act_dat[static_cast<uint8_t>(vac_dat::addr_e::_max)];
...
struct seq_dat{
  ...
  dat_t sequencing_dat[static_cast<uint8_t>(seq_dat::addr_e::_max)];
